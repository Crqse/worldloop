...
- This is a **research-grade** alpha, not a production battle-tested system.
...
Four sibling packages, one flat repo, all green on Ubuntu + Windows × Python
...
Follow the discussion, open issues, or email 1148395497@qq.com — happy to
talk about paid integration support, technical support subscriptions, or
custom development.*
